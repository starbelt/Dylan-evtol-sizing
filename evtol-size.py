...
if enable_shorter_range_analysis and jettison_opt_enable and optimal_jettison_results and optimal_jettison_results['found_optimum']:
    ...
    try:
        ...
        batt_rated_energy_k_W_h_post_opt = calc_batt_rated_energy_k_W_h(pack_spec_energy_gross_BOL_Wh_kg , opt_mass)
    
    
        cruise_c_rate_post_op = calc_batt_C_rate_cruise(batt_rated_energy_k_W_h_post_opt, cruise_power_post_opt)
        hover_c_rate_post_op = calc_batt_C_rate_hover(batt_rated_energy_k_W_h_post_opt,hover_power_post_opt)
        print(f"hover c: {hover_c_rate_post_op}")
        print(f"cruise c: {cruise_c_rate_post_op}")
